...
import app.syfre.syfre.AddictionCardAdapter
import app.syfre.syfre.R
import app.syfre.syfre.databinding.ActivityMainBinding
import app.syfre.syfre.databinding.DialogAddNoteAfterRelapseBinding
import app.syfre.syfre.databinding.DialogMiscBinding
...
import app.syfre.syfre.utils.getAddNoteAfterRelapsePref
...
class Main : AppCompatActivity() {
    ...
    companion object {
        const val EXTRA_NAMES = "app.syfre.syfre.EXTRA_NAMES"
        // Pass the position of the addiction so that it can be modified
        const val EXTRA_ADDICTION_POSITION = "app.syfre.syfre.EXTRA_ADDICTION_POSITION"
