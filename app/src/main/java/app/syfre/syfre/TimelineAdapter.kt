...
import app.syfre.syfre.databinding.ListItemTimelineBinding
...
class TimelineAdapter(addiction: Addiction, private val context: Context):
    ...
    override fun onBindViewHolder(holder: TimelineViewHolder, position: Int) {
        ...
        if (pair.second == 0L) {
            ...
            holder.dateRange.text = context.getString(
                R.string.time_range, dateFormat.format(Instant.ofEpochMilli(pair.first).atZone(ZoneId.systemDefault())),
